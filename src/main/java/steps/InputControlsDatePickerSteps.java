...
public class InputControlsDatePickerSteps extends BasePage {
    ...
    public void escolherAno(String ano) {
        ...
        while (!verifyIfTextIsDisplayedOnScreen(ano)&&i<10) {
            if((anoInt<1994))
            {
               scroll(0.5,0.8);
            }
    ...
    public void escolherMes(String mes) {
        ...
        while (!(verifyIfTextIsDisplayedOnScreen(mesString[mesInt]))&&i<10) {
            if((mesInt>7))
            {
    ...
    public void escolherAnoIos(String ano) {
        ...
        while (!verifyIfTextIsDisplayedOnElement(lblAno, ano)&&i<40) {
            if((anoInt<2019))
            {
                scrollbyCoordinates(280,280,280,314);
            }
            else
            {
                scrollbyCoordinates(280,280,280,243);
            }
            i++;
        }
       //clicarPorTexto(ano);
    ...
    public void escolherDiaIos(String dia) {
        int i=0;
        while (!verifyIfTextIsDisplayedOnElement(lblDia, dia)&&i<32) {
            scrollbyCoordinates(205,280,205,314);
            i++;
        }
        //clicarPorTexto(dia);
    }
    ...
    public void escolherMesIos(String mes) {
        ...
        while (!(verifyIfTextIsDisplayedOnElement(lblMes, mesString[mesInt]))&&i<12) {
            scrollbyCoordinates(90,280,90,314);
            i++;
        }
        //clicarPorTexto(mes);
    }
